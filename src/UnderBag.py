"""
Description: This file contains a class that implements "Random Under Bagging (UnderBag)" algorithm using scikit-learn.
UnderBag is a multi-class classification algorithm.
...
class UnderBag(object):
    ...
    def __make_bootstraps(self,data):       
        ...
        for b in range(self.n_estimator):
            resamp = RandomUnderSampler(sampling_strategy='majority', random_state=random.randint(1,100))
